...
class DFS:
    ...
    def DFS(self, root_node, goal_state):
        temp_node = Node.Node(None, None)
        root_node = temp_node.copy(root_node)  # Use copy constructor to ensure that the root_node is an actual Node
        ...
        while self.open_list:
            current_node = self.open_list.pop()   # Get the first element on the stack
            ...
            self.open_list.insert(0, children_to_add)
